...
public class SlideCooldown : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (playerRuntimeData.SlideAction_resourceRuntimeData.GetCurrentResource() < 0.5) // 0 charges
        {
            ...
            imageCooldown.fillAmount = 1f - (playerRuntimeData.SlideAction_resourceRuntimeData.GetCurrentResource() / 0.5f);
            numChargesBackground.fillAmount = (playerRuntimeData.SlideAction_resourceRuntimeData.GetCurrentResource() / 0.5f);
            if (playerRuntimeData.SlideAction_resourceRuntimeData.GetCurrentResource() < 0.17f)
            {
                textCooldown.text = "3";
            }
            else if (playerRuntimeData.SlideAction_resourceRuntimeData.GetCurrentResource() < 0.33f)
            {
                textCooldown.text = "2";
            }
            else
        ...
        else if (playerRuntimeData.SlideAction_resourceRuntimeData.GetCurrentResource() < 1)
        {
            ...
            numChargesBackground.fillAmount = (playerRuntimeData.SlideAction_resourceRuntimeData.GetCurrentResource() - 0.5f) / 0.5f;
        }
        else
        {
