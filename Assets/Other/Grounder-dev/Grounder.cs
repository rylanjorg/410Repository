...
namespace Locomotion.Utils.Grounder
{
        public class Grounder : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _leftFootUpHash = Animator.StringToHash("LeftFootUp");
            _rightFootUpHash = Animator.StringToHash("RightFootUp");
        }
        ...
        private void SetIkRotationWeight()
        {
            ...
            float weightL = 1f - _animator.GetFloat(_leftFootUpHash);
            float weightR = 1f - _animator.GetFloat(_rightFootUpHash);
