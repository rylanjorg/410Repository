...
public class PlayerIK : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //playerWeaponContainer = playerRoot.GetComponent<PlayerWeaponContainer>();
    }
    ...
    void Start()
    {
     ...
     void Update()
    {
        if(LeftHandIKTarget == null || RightHandIKTarget == null || LeftElbowIKTarget == null || RightElbowIKTarget == null && playerWeaponContainer != null && playerWeaponContainer.WeaponInstance != null) Setup();
    }
    ...
    public void Setup()
    {
        if(playerWeaponContainer == null || playerWeaponContainer.WeaponInstance == null) return;
        Transform[] allChildren = playerWeaponContainer.WeaponInstance.GetComponentsInChildren<Transform>();
